...
<article class="catalog-item h-100 d-flex flex-column js-product-container">
    ...
    <a href="<?= $arElement["DETAIL_PAGE_URL"] ?>"
       ...
       class="catalog-item__image">
        ...
        <img src="<?php echo !empty($arElement["DETAIL_PICTURE"]["SRC"]) ? $arElement["DETAIL_PICTURE"]["SRC"] : (!empty($arElement["PREVIEW_PICTURE"]["SRC"]) ? $arElement["PREVIEW_PICTURE"]["SRC"] : SITE_TEMPLATE_PATH . "/images/product-placeholder.jpeg"); ?>"
